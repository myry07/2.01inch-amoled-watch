...
/* LCD pins */
#define EXAMPLE_LCD_CS            (GPIO_NUM_40)
#define EXAMPLE_LCD_PCLK          (GPIO_NUM_21)
#define EXAMPLE_LCD_DATA0         (GPIO_NUM_47)
#define EXAMPLE_LCD_DATA1         (GPIO_NUM_45)
#define EXAMPLE_LCD_DATA2         (GPIO_NUM_38)
#define EXAMPLE_LCD_DATA3         (GPIO_NUM_39)
#define EXAMPLE_LCD_RST           (GPIO_NUM_41)
...
#define EXAMPLE_TOUCH_INT           (GPIO_NUM_14)
...
static esp_err_t app_lcd_init(void)
{
   ...
   const spi_bus_config_t buscfg = CO5300_PANEL_BUS_QSPI_CONFIG(EXAMPLE_LCD_PCLK,
    ...
    esp_lcd_panel_set_gap(lcd_panel, 16, 0);
