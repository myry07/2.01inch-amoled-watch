...
#define ESP_LCD_TOUCH_CST816_VER_MAJOR    (1)
#define ESP_LCD_TOUCH_CST816_VER_MINOR    (0)
#define ESP_LCD_TOUCH_CST816_VER_PATCH    (3)
...
/**
 * @brief I2C address of the CST816 controller
 *
 */
#define ESP_LCD_TOUCH_IO_I2C_CST816_ADDRESS    (0x15)  // CST816
